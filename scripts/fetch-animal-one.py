#!/usr/bin/env python3
"""
Fetch or re-fetch a single animal and merge it into animal-game/js/animal-data.js.
Usage: make fetch-animal-one ANIMAL="Homo_sapiens"
   or: python3 scripts/fetch-animal-one.py "Homo_sapiens"
"""
...
if len(sys.argv) < 2:
    print("Usage: python3 scripts/fetch-animal-one.py <WikiTitle>")
    sys.exit(1)
